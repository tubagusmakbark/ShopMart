        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.profil}>
                    <Text style={styles.textName}>Tubagus M Akbar K</Text>
                    <Text style={styles.textJob}>ShopMart Developer</Text>
                </View>
                    ...
                    <ImageBackground style={styles.backPortofolio}>
                        ...
                        <View style={styles.protofolio}>
                            <View style={styles.daftarPortofolio}>
                                ...
                                <Text style={styles.txtPort1} >@tubagusmakbark </Text>
                            </View>
                ...
                <View>
                    <ImageBackground style={styles.backHubungi}>
                        ...
                        <View style={styles.kontak}>
                            ...
                            <Text style={{ color: "#003366", fontWeight: "bold", fontSize: 16 }}>Tubagus M Akbar K</Text>
                        </View>
                        <View style={styles.kontak}>
                            <Icon name="instagram" size={25} color="#3EC6FF" />
                            <Text style={{ color: "#003366", fontWeight: "bold", fontSize: 16 }}>@tubagusmakbark</Text>
                        </View>
                        <View style={styles.kontak}>
                            <Icon name="twitter" size={25} color="#3EC6FF" />
                            <Text style={{ color: "#003366", fontWeight: "bold", fontSize: 16 }}>@BakzTs</Text>
                        </View>
                    </ImageBackground>
                </View>
            </View>
